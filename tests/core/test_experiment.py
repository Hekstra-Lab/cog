...
@pytest.mark.parametrize(
    "center", [None, (1990, 1970), [1990, 1970], (1991.0, 1970.0), [1990.0, 1970.0]]
)
@pytest.mark.parametrize(
    "pixelSize", [None, (88, 88), [88, 88], (88.6, 88.6), [88.6, 88.6]]
)
@pytest.mark.parametrize(
    "cell", [None, [1.0, 2.0, 3.0, 90.0, 90.0, 90.0], (1.0, 2.0, 3.0, 90.0, 90.0, 90.0)]
)
@pytest.mark.parametrize("spacegroup", [None, 1, 19, 96, 1.0])
def test_constructor(
    images, pathToImages, distance, center, pixelSize, cell, spacegroup
):
